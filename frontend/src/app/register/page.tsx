      ...
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden bg-gradient-to-br from-[#0f1623] to-[#0a0d14] items-center justify-center p-12 flex-col">
        ...
        <div className="relative">
          ...
          <p className="text-slate-400 text-lg leading-relaxed mb-10">
            Join thousands of students using AI to study smarter, retain more, and ace their exams.
          </p>

          <div className="grid grid-cols-2 gap-4">
            {[
              { title: 'AI Chat', desc: 'Talk to your notes' },
              { title: 'Flashcards', desc: 'Auto-generated from docs' },
              { title: 'Study Plans', desc: 'Personalized schedules' },
              { title: 'Progress', desc: 'Track your growth' },
            ].map((f) => (
              <div key={f.title} className="p-4 rounded-xl border border-white/5 bg-white/[0.03]">
                <p className="text-white text-sm font-semibold mb-0.5">{f.title}</p>
                <p className="text-slate-600 dark:text-slate-400 text-xs">{f.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-[420px]">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-400 text-sm">Get started for free, no credit card required</p>
          </div>
